    ...
    <main className="min-h-screen bg-[#070707] text-white">
      <section className="relative overflow-hidden border-b border-[#b88945]/20">
        ...
        <nav className="relative z-10 mx-auto flex max-w-7xl items-center justify-between px-5 py-6 sm:px-6 lg:py-7">
          ...
          <a href="mailto:kahlok996@gmail.com" className="hidden rounded-full border border-[#c79a55]/40 px-5 py-3 text-xs font-bold uppercase tracking-[0.16em] text-[#c79a55] sm:inline-flex">
            Audit
          </a>
        </nav>
        ...
        <div className="relative z-10 mx-auto grid max-w-7xl grid-cols-1 items-center gap-10 px-5 pb-14 pt-8 sm:px-6 md:pb-20 lg:grid-cols-[1.05fr_.95fr] lg:pb-28 lg:pt-16">
          <div className="text-center lg:text-left">
            ...
            <div className="mt-8 flex flex-col gap-4 sm:mx-auto sm:max-w-md sm:flex-row lg:mx-0 lg:mt-10">
              <a href="mailto:kahlok996@gmail.com" className="group inline-flex items-center justify-center gap-3 rounded-full bg-[#c79a55] px-6 py-4 text-xs font-bold uppercase tracking-[0.16em] text-black transition hover:bg-white sm:px-7 sm:text-sm">
      ...
      <section id="work" className="px-5 py-14 sm:px-6 sm:py-20">
        <div className="mx-auto max-w-7xl">
          <div className="mb-10 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            ...
            <a href="mailto:kahlok996@gmail.com" className="inline-flex items-center gap-2 text-xs font-bold uppercase tracking-[0.25em] text-white/80 transition hover:text-[#c79a55]">
      ...
      <section id="contact" className="px-5 py-14 sm:px-6 sm:py-20">
        <div className="mx-auto grid max-w-7xl items-center gap-10 rounded-[2rem] border border-[#c79a55]/25 bg-[#111] p-6 sm:p-8 md:grid-cols-[1fr_auto] md:p-12">
          ...
          <div className="flex flex-col gap-4">
            <a href="mailto:kahlok996@gmail.com" className="inline-flex items-center justify-center gap-3 rounded-full bg-[#c79a55] px-7 py-4 text-sm font-bold uppercase tracking-[0.16em] text-black transition hover:bg-white">
